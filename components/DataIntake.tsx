...
const DataIntake: React.FC<DataIntakeProps> = ({ onStart, language }) => {
  ...
  return (
    <div className={`max-w-3xl mx-auto animate-fade-in pb-10 ${isRTL ? 'font-tajawal text-right' : 'font-sans text-left'}`} dir={isRTL ? 'rtl' : 'ltr'}>
        ...
        <form onSubmit={handleSubmit} className="space-y-10 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
             ...
             <div className="space-y-2">
                ...
                <p className="text-[10px] text-slate-500 font-black px-2">{isRTL ? 'لتحليل فرص النمو الضائعة يومياً.' : 'To analyze daily missed growth.'}</p>
             </div>
          </div>
      ...
      <div className="text-center mt-12 text-[10px] font-black text-slate-600 uppercase tracking-[0.5em] opacity-50">
