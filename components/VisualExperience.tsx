    ...
    <div className="max-w-6xl mx-auto flex flex-col items-center animate-fade-in pb-10 relative font-tajawal text-right px-4" dir="rtl">
                ...
                <div className="flex-1 flex flex-col bg-white h-full overflow-hidden p-4 lg:p-6 items-center text-center mt-32" dir="rtl">
                   ...
                   {rating && !isSent && (
                      <div className="w-full animate-fade-in-up space-y-3">
                         <textarea value={feedbackText} onChange={(e) => setFeedbackText(e.target.value)} placeholder="اكتب ملاحظاتك هنا..." className="w-full p-3 bg-slate-50 border border-slate-200 rounded-xl text-xs font-bold outline-none h-20 resize-none focus:border-blue-500"></textarea>
      ...
      <div className="w-full max-w-[420px] space-y-4 mt-8 lg:mt-12 px-4 flex flex-col items-center">
          ...
          <div className="relative group w-full">
             <div className="absolute -top-4 z-20 bg-yellow-400 text-black font-black text-[10px] px-3 py-1 rounded-lg shadow-[0_0_15px_rgba(250,204,21,0.6)] animate-pulse border-2 border-black rotate-2 right-0">🔥 خصم 70% متاح الآن</div>
          ...
          <button onClick={onBack} className="w-full py-2 text-slate-500 font-bold hover:text-white transition-all flex items-center justify-center gap-2 text-[10px] uppercase tracking-[0.2em] opacity-60">
